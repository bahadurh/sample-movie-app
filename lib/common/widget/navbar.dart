      ...
      child: Container(
        ...
        child: Theme(
          ...
          child: BottomNavigationBar(
            ...
            selectedLabelStyle: const TextStyle(color: AppColors.white, fontSize: 10, fontWeight: FontWeight.w600),
            unselectedLabelStyle: const TextStyle(color: AppColors.greyDark, fontSize: 10, fontWeight: FontWeight.w600),
